...
if [ $? -eq 0 ]; then
    ...
    echo "El clima actual en $ciudad_aleatoria: temp:$temperatura_celsius°C" 

    # Realizamos una solicitud POST
    wget -O - --method=POST http://localhost:8080/device --body-data="id=$1&n=$2&k=$3&t=$temperatura_celsius"
